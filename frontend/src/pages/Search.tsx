...
const Search = () => {
    ...
    const handleHotelTypeChnage = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleFacilitiesTypeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        >
            <div className="rounded-lg border border-slate-300 p-5 h-fit sticky top-10">
                <div className="space-y-5">
                    <h3
                        className="text-lg font-semibold border-b border-slate-300 pb-5">
                        Filter by:
                    </h3>
                    <StarRatingFilter
                    ...
                    />
                    <HotelTypeFilter
                        selectedType={selectedHotelType}
                        onChange={handleHotelTypeChnage}
                    />
                    <FacilitiesFilter
                        selectedFacilities={selectedFacilities}
                        onChange={handleFacilitiesTypeChange}
                    />
                    <PriceFilter
